...
class Balok():
    ...
    def luas(self):
        luas_balok = 2 * (self.panjang * self.lebar +
                          self.lebar * self.tinggi + self.panjang)
...
class LimasSegitiga():
    ...
    def volume(self):
        ...
        print("volume limas segitiga adalah : ",
              round(volume_limasSegitiga, 2))

    def luas(self):
        luas_limasSegitiga = 1/2 * self.alas * \
            self.tinggiA + (3 * 1/2 * self.alas * self.tinggiA)
